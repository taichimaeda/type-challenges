...
type AnyOf<T extends readonly any[]> = 
  T[number] extends false | 0 | '' | [] | Record<any, never> | undefined | null ? false : true

// NOTE:
// This solution does not work:
// type AnyOf<T extends readonly any[]> =
//   T extends [infer Head, ...infer Tail]
//     ? Head extends true | 1 | Exclude<string, ''> | Exclude<any[], []> | Exclude<{}, Record<string, never>> ? true : AnyOf<Tail>
//     : false
