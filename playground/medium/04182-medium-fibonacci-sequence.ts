...
// NOTE:
// This implementation is zero-indexed but the test cases are 1-indexed.
// The leftmost `[0, ...Count]` takes this into account.
type Fibonacci<T extends number, Count extends any[] = [], Curr extends any[] = [0], Prev extends any[] = []> = 
  [0, ...Count]['length'] extends T ? Curr['length'] : Fibonacci<T, [0, ...Count], [...Curr, ...Prev], Curr>
