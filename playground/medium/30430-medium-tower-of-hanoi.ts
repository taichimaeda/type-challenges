...
type Hanoi<N extends number, From = 'A', To = 'B', Intermediate = 'C', Count extends any[] = [], Steps extends string[] = []> =
  Count['length'] extends N
    ? []
    : [...Hanoi<N, From, Intermediate, To, [0, ...Count], Steps>, [From, To], ...Hanoi<N, Intermediate, To, From, [0, ...Count], Steps>]
