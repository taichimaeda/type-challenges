...
// https://microsoft.github.io/PowerBI-JavaScript/interfaces/_node_modules_typedoc_node_modules_typescript_lib_lib_es5_d_.promiselike.html
type MyAwaited<T extends PromiseLike<any>> = T extends PromiseLike<infer R> ? MyAwaitedRec<R> : never
type MyAwaitedRec<T> = T extends PromiseLike<infer R> ? MyAwaitedRec<R> : T
